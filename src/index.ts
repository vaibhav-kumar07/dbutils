...
if (!MONGO_URI) throw new Error('MONGO_URI is required in the environment variables.');
if (!DATABASE_NAME) console.warn('DATABASE_NAME is missing; using database name in URI if available.');
